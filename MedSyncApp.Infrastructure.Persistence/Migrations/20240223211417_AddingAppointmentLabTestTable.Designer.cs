...
namespace MedSyncApp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240223211417_AddingAppointmentLabTestTable")]
    partial class AddingAppointmentLabTestTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppointmentLabTest", b =>
                {
                    ...
                    b.HasKey("AppointmentsId", "LabTestsId");

                    b.HasIndex("LabTestsId");

                    b.ToTable("AppointmentLabTest", (string)null);
                });
            ...
            modelBuilder.Entity("AppointmentLabTest", b =>
                {
                    b.HasOne("MedSyncApp.Core.Domain.Entities.Appointment", null)
                        .WithMany()
                        .HasForeignKey("AppointmentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MedSyncApp.Core.Domain.Entities.LabTest", null)
                        .WithMany()
